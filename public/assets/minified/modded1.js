...
function() {
    ...
    $(".notice-flash").length > 0 && $(".notice-flash").delay(2300).slideUp(), $("noscript").length > 0 && $("noscript").remove(), void 0 === $.cookie("yts_lang") && $.ajax({}), document.body.addEventListener("touchstart", function(e) {
        var t = jQuery("body");
