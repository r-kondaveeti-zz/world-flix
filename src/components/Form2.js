...
export class Form2 extends React.Component  {
    ...
    render() {
        return (
            ...
            //     </div>
            // </form>
            <form method="get" onSubmit={this.onSubmit} acceptCharset="UTF-8" id="quick-search" name="quick-search">
            <div id="quick-search-container">
              <input id="quick-search-input" name="query" onChange={this.onChange} autoComplete="off" type="search" defaultValue="Quick search" />
